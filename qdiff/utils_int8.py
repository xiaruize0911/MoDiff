...
from qdiff.quant_layer_int8 import QuantModuleINT8, UniformAffineQuantizerINT8
...
def save_inp_oup_data_int4(model: QuantModelINT8, layer: Union[QuantModuleINT8, BaseQuantBlockINT8], cali_data: torch.Tensor,
    ...
    :param layer: QuantModuleINT8 or QuantBlockINT4
...
def save_inp_oup_data_modiff_int4(model: QuantModelINT8, layer: Union[QuantModuleINT8, BaseQuantBlockINT8], cali_data: torch.Tensor,
                      asym: bool = False, act_quant: bool = False, batch_size: int = 32, keep_gpu: bool = True,
                      cond: bool = False, is_sm: bool = False):
    """
    Save input data and output data of a particular layer/block over calibration dataset.
...
def save_grad_data_int4(model: QuantModelINT8, layer: Union[QuantModuleINT8, BaseQuantBlockINT8], cali_data: torch.Tensor,
...
class GetLayerInpOutINT4:
    def __init__(self, model: QuantModelINT8, layer: Union[QuantModuleINT8, BaseQuantBlockINT8],
...
def quantize_model_till_int4(model: QuantModuleINT8, layer: Union[QuantModuleINT8, BaseQuantBlockINT8], act_quant: bool = False):
    """
    ...
    for name, module in model.named_modules():
        if isinstance(module, (QuantModuleINT8, BaseQuantBlockINT8)):
        ...
        if isinstance(module, QuantModuleINT8):
            ...
            if module.ignore_reconstruction is True:
                ...
                for name, sub_module in module.named_modules():
                    if isinstance(sub_module, QuantModuleINT8):
...
def resume_cali_model_int8(qnn, ckpt_path, cali_data, quant_act=False, act_quant_mode='qdiff', cond=False):
    ...
    if quant_act:       
        ...
        for m in qnn.model.modules():
            if isinstance(m, AdaRoundQuantizer):
                m.zero_point = nn.Parameter(m.zero_point)
                m.delta = nn.Parameter(m.delta)
            elif isinstance(m, UniformAffineQuantizerINT8):

...
def block_reconstruction_int8(model: QuantModelINT8, block: BaseQuantBlockINT8, cali_data: torch.Tensor,
    ...
    :param block: BaseQuantBlockINT8 that needs to be optimized

...
def block_reconstruction_int4(model: QuantModelINT4, block: BaseQuantBlockINT4, cali_data: torch.Tensor,
    ...
    :param block: BaseQuantBlockINT4 that needs to be optimized
    ...
    loss_func = LossFunctionINT4(block, round_loss=loss_mode, weight=weight, max_count=iters, rec_loss=rec_loss,

...
import logging
from qdiff.quant_layer_int4 import QuantModuleINT4, StraightThrough, lp_loss
...
def layer_reconstruction_int4(model: QuantModelINT4, layer: QuantModuleINT4, cali_data: torch.Tensor,
    ...
    :param layer: QuantModuleINT4 that needs to be optimized
    ...
    loss_func = LossFunctionINT4(layer, round_loss=loss_mode, weight=weight,
...
def layer_reconstruction_modiff_int4(model: QuantModelINT4, layer: QuantModuleINT4, cali_data: torch.Tensor,
                         batch_size: int = 32, iters: int = 20000, weight: float = 0.001, opt_mode: str = 'mse',
                         asym: bool = False, include_act_func: bool = True, b_range: tuple = (20, 2),
                         warmup: float = 0.0, act_quant: bool = False, lr: float = 4e-5, p: float = 2.0,
...
class LossFunctionINT4:
    def __init__(self,
                 layer: QuantModuleINT4,

...
from qdiff import (
    QuantModelINT4, QuantModuleINT4, BaseQuantBlockINT4, 
    block_reconstruction_int4, layer_reconstruction_int4, layer_reconstruction_modiff_int4
)
from qdiff.adaptive_rounding import AdaRoundQuantizer
from qdiff.quant_layer_int4 import UniformAffineQuantizerINT4
from qdiff.utils_int4 import resume_cali_model_int4, get_train_samples
...
class DiffusionINT4(object):
    ...
    def sample(self):
        ...
        if self.args.ptq:
            ...
            aq_params = {
                'n_bits': 4, 'symmetric': args.a_sym, 'channel_wise': args.act_tensor, 'scale_method': 'max', 
            ...
            if self.args.resume:
                ...
                resume_cali_model_int4(qnn, args.cali_ckpt, cali_data, args.quant_act, args.quant_mode, cond=False)
            else:
                ...
                if self.args.resume_w:
                    resume_cali_model_int4(qnn, self.args.cali_ckpt, cali_data, False, cond=False)
                else:
                ...
                def recon_model(model):
                    ...
                    for name, module in model.named_children():
                        logger.info(f"{name} {isinstance(module, BaseQuantBlockINT4)}")
                        if isinstance(module, QuantModuleINT4):
                            if module.ignore_reconstruction is True:
                                ...
                                layer_reconstruction_int4(qnn, module, **kwargs)
                            ...
                            if module.ignore_reconstruction is True:
                                ...
                                block_reconstruction_int4(qnn, module, **kwargs)
                        else:
                            recon_model(module)
                    ...
                    for name, module in model.named_children():
                        ...
                        if isinstance(module, QuantModuleINT4):
                            if module.ignore_reconstruction is True:
                                ...
                                logger.info('Reconstruction for layer {}'.format(name))
                                layer_reconstruction_modiff_int4(qnn, module, **kwargs)
                        else:
                ...
                for m in qnn.model.modules():
                    ...
                    elif isinstance(m, UniformAffineQuantizerINT4) and self.args.quant_act:
...
if __name__ == "__main__":
    ...
    runner = DiffusionINT4(args, config)
    runner.sample()

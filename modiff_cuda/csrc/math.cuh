/*
 * Copied from Flashinfer, https://github.com/flashinfer-ai/flashinfer/blob/v0.1.5/include/flashinfer/mma.cuh
...
// log2(127), actually log2(126) to prevent overflow
constexpr float log2_127 = 6.97728f;

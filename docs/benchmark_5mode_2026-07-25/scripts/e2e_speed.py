...
Post-fix re-run (2026-07-25) after: attention Q/K quantize merge, _qkv_from_gn wiring,
forward_gn_fused_modiff o_hat+residual fusion, Upsample->conv quantize fusion, B-family
linear fake-quant fix, --no_attention ablation fix. Same methodology as
docs/benchmark_5mode_2026-07-23/scripts/e2e_speed.py (not overwritten -- kept as the
pre-fix baseline for comparison), written to a new dated folder instead.
...
HERE = "docs/benchmark_5mode_2026-07-25"
...
def run(mode):
    ...
    r = B.BenchmarkRunner("configs/latent-diffusion/lsun_churches-ldm-kl-8.yaml",
                          "models/ldm/lsun_churches256/model.ckpt", output_dir="integration/results/bench5mode_20260725",

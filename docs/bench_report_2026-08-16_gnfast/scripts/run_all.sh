#!/bin/bash
# Four measurements for docs/bench_report_2026-08-16_gnfast. SEQUENTIAL ON PURPOSE: a second CUDA process
...
D=/workspace/MoDiff/docs/bench_report_2026-08-16_gnfast
S=$(date +%s)

"""Emit docs/bench_report_2026-08-16_gnfast/REPORT.md -- one file, all four measurements, data + figures.
...
Run: python docs/bench_report_2026-08-16_gnfast/scripts/make_report.py    # no GPU
"""
import json
import os
import sys
...
_bench_plots = _load("modiff_bench_plots", "docs/bench_report_2026-08-16_gnfast/scripts/make_plots.py")
...
def main():
    ...
    o.append("```bash")
    o.append("bash docs/bench_report_2026-08-16_gnfast/scripts/run_all.sh   # all four measurements + plots")
    o.append("python docs/bench_report_2026-08-16_gnfast/scripts/make_report.py   # regenerate this file")
    o.append("```")
    out = f"{D}/REPORT.md"
    open(out, "w").write("\n".join(o) + "\n")

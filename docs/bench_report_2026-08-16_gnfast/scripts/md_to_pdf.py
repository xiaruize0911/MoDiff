...
Run: python docs/bench_report_2026-08-16_gnfast/scripts/md_to_pdf.py [in.md] [out.pdf]
"""
import os
import sys
...
os.chdir(ROOT)
SRC = sys.argv[1] if len(sys.argv) > 1 else "docs/bench_report_2026-08-16_gnfast/SUMMARY.md"

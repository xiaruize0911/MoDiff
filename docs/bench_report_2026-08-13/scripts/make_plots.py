"""Figures for docs/bench_report_2026-08-13, from the JSON the four measurement steps wrote.
...
Run: python docs/bench_report_2026-08-13/scripts/make_plots.py    # no GPU
"""
import json
import os
import sys

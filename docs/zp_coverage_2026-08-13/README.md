...
| **P5** | W8A8 noise floor 1.3–5.1% makes <5% unresolvable on that axis | **Floors hold** (W4A4 0.09%/0.13%, W8A8 1.97%/0.91%). But they are not the binding constraint: **arm order moves W4A4 MoDiff by 27.8%**, which explains the 6.9% `arm_position_effect.py` could not and retracts its verdict. | [FINDINGS_NOISE_FLOOR.md](FINDINGS_NOISE_FLOOR.md) |

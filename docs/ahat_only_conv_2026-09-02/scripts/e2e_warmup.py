"""E2E ms/step + peak + decoded latent for one MODIFF_WARMUP_STEPS. argv: mode WARMUP"""
...
torch.save(lat, f"/tmp/lat_{MODE}_wu{WU}.pt")
print("E2EJSON:"+json.dumps({"mode":MODE,"warmup":int(WU),"ms_step":statistics.median(ts),

...
ARMS = [("int4_l1", "0", "W4A4 MoDiff  L1 + DYNAMIC"),
        ("int4_l0", "1", "W4A4 MoDiff  L0 + STATIC"),
        ("int4_l1", "1", "W4A4 MoDiff  L1 + static (repeat)")]
...
p = "docs/w4a4_quality_2026-08-17/data/noise_floor_isolate.json"

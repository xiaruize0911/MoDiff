...
SHOW = ["int4_modiff_l0", "int4_modiff_l0_adaround", "int4_modiff_l1", "int4_modiff_l1_adaround"]
...
grid(ns[:6], f"{OUT}/all_arms_w4a4.png")
grid(ns[:4], f"{OUT}/all_arms_w4a4_zoom.png", crop=(64, 64, 128))
json.dump({"dir": B, "n_paired": len(ns), "mean_abs_delta_vs_fp16_255": D,
          ...
          open(f"{OUT}/all_arms_w4a4.json", "w"), indent=1)
print("OK")
